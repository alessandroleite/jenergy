...
public abstract class MethodExecutionInterceptor
{
     ...
     */
    public Object invoke(Method method, Object invoker) throws Throwable
    {
        Object result;
        ...
        MethodInfo profile = Cpu.getInstance().monitor(method);
        ...
        finally
        {
            ...
            if (bean != null)
            {
                ...
                profile.getTimes().getCpuTime().setEndTime(cpuTime);
                profile.getTimes().getUserTime().setEndTime(userTime);
            }
